...
#include<stdlib.h>
#include<time.h>
//Pi Number aprox with Monte Carlo Method
using namespace std;
int main(){
	int jmax=1000.0; // maximum value of HIT number. (Length of output file)
	int imax=1000.0; // maximum value of random numbers for producing HITs.
